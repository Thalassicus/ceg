...
INSERT INTO Unit_ClassUpgrades (UnitType, UnitClassType) SELECT DISTINCT Type, 'UNITCLASS_GATLINGGUN'	FROM Units WHERE Class = 'UNITCLASS_PIKEMAN';
INSERT INTO Unit_ClassUpgrades (UnitType, UnitClassType) SELECT DISTINCT Type, 'UNITCLASS_MACHINE_GUN'	FROM Units WHERE Class = 'UNITCLASS_GATLINGGUN';
INSERT INTO Unit_ClassUpgrades (UnitType, UnitClassType) SELECT DISTINCT Type, 'UNITCLASS_BAZOOKA'		FROM Units WHERE Class = 'UNITCLASS_MACHINE_GUN';
