...
UPDATE Units SET Cost = Cost * 1.389, Combat = Combat * 1                                           WHERE Class = 'UNITCLASS_XCOM_SQUAD';
...
UPDATE Units SET Cost = Cost * 0.993, Combat = Combat * 1.267                                       WHERE Class = 'UNITCLASS_HELICOPTER_GUNSHIP';
...
UPDATE Units SET Cost = Cost * 0.519, Combat = Combat * 0.538                                       WHERE Class = 'UNITCLASS_PARATROOPER';
...
UPDATE Units SET Cost = Cost * 0.608, Combat = Combat * 0.7                                         WHERE Class = 'UNITCLASS_GREAT_WAR_INFANTRY';
UPDATE Units SET Cost = Cost * 0.844, Combat = Combat * 1.19 , RangedCombat = RangedCombat * 1.357  WHERE Class = 'UNITCLASS_ARTILLERY';
UPDATE Units SET Cost = 280         , Combat = 28                                                   WHERE Class = 'UNITCLASS_CONSCRIPT';
...
UPDATE Units SET Cost = Cost * 1.111, Combat = Combat * 1.48                                        WHERE Class = 'UNITCLASS_LANCER';
...
UPDATE Units SET Cost = 200         , Combat = 20                                                   WHERE Class = 'UNITCLASS_MILITIA';
...
UPDATE Units SET Cost = Cost * 0.893, Combat = Combat * 0.818                                       WHERE Class = 'UNITCLASS_SPEARMAN';
...
UPDATE Units SET Cost = Cost * 1.033, Combat = 60 , RangedCombat = 79, Range = 3, CombatClass = 'UNITCOMBAT_NAVALRANGED', Moves = 8  WHERE Class = 'UNITCLASS_MISSILE_CRUISER';
UPDATE Units SET Cost = 600         , Combat = 60 , RangedCombat = 0 , Range = 0, CombatClass = 'UNITCOMBAT_NAVALMELEE' , Moves = 8  WHERE Class = 'UNITCLASS_MISSILE_DESTROYER';
UPDATE Units SET Cost = Cost * 1.19 , Combat = 30 , RangedCombat = 91, Range = 1, CombatClass = 'UNITCOMBAT_SUBMARINE'  , Moves = 7  WHERE Class = 'UNITCLASS_NUCLEAR_SUBMARINE';
UPDATE Units SET Cost = Cost * 0.785, Combat = 53 , RangedCombat = 0 , Range = 0, CombatClass = 'UNITCOMBAT_NAVALMELEE' , Moves = 7  WHERE Class = 'UNITCLASS_CARRIER';
UPDATE Units SET Cost = Cost * 0.785, Combat = 40 , RangedCombat = 53, Range = 3, CombatClass = 'UNITCOMBAT_NAVALRANGED', Moves = 6  WHERE Class = 'UNITCLASS_BATTLESHIP';
UPDATE Units SET Cost = Cost * 0.622, Combat = 42 , RangedCombat = 0 , Range = 0, CombatClass = 'UNITCOMBAT_NAVALMELEE' , Moves = 7  WHERE Class = 'UNITCLASS_DESTROYER';
UPDATE Units SET Cost = Cost * 1.077, Combat = 21 , RangedCombat = 63, Range = 1, CombatClass = 'UNITCOMBAT_SUBMARINE'  , Moves = 6  WHERE Class = 'UNITCLASS_SUBMARINE';
