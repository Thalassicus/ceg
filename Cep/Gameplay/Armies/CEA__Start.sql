...
UPDATE Units SET Cost = Cost * 2.157, Combat = Combat * 1.1                                         WHERE Class = 'UNITCLASS_MECH';
UPDATE Units SET Cost = Cost * 0.833, Combat = Combat * 0.727                                       WHERE Class = 'UNITCLASS_XCOM_SQUAD';
...
UPDATE Units SET Cost = Cost * 1.569, Combat = Combat * 1.2                                         WHERE Class = 'UNITCLASS_MODERN_ARMOR';
...
UPDATE Units SET Cost = Cost * 0.385, Combat = Combat * 0.538                                       WHERE Class = 'UNITCLASS_PARATROOPER';
UPDATE Units SET Cost = Cost * 0.667, Combat = Combat * 0.643                                       WHERE Class = 'UNITCLASS_INFANTRY';
UPDATE Units SET Cost = Cost * 1.111, Combat = Combat * 1.167, RangedCombat = RangedCombat * 0.833  WHERE Class = 'UNITCLASS_MACHINE_GUN';
...
UPDATE Units SET Cost = 210         , Combat = 28                                                   WHERE Class = 'UNITCLASS_CONSCRIPT';
UPDATE Units SET Cost = Cost * 0.988, Combat = Combat * 1.333, RangedCombat = RangedCombat * 1      WHERE Class = 'UNITCLASS_GATLINGGUN';
...
UPDATE Units SET Cost = 150         , Combat = 20                                                   WHERE Class = 'UNITCLASS_MILITIA';
...
UPDATE Units SET Cost = Cost * 0.679, Combat = Combat * 0.938                                       WHERE Class = 'UNITCLASS_PIKEMAN';
...
UPDATE Units SET Cost = Cost * 0.694, Combat = Combat * 0.818                                       WHERE Class = 'UNITCLASS_SPEARMAN';
