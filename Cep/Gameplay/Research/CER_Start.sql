...
UPDATE Technologies SET GridY=6 WHERE Type IN ('TECH_ARCHERY', 'TECH_TRAINING', 'TECH_MATHEMATICS', 'TECH_ENGINEERING', 'TECH_MACHINERY', 'TECH_PRINTING_PRESS', 'TECH_METALLURGY', 'TECH_STEAM_POWER', 'TECH_INDUSTRIALIZATION', 'TECH_FLIGHT', 'TECH_COMBUSTION', 'TECH_ATOMIC_THEORY', 'TECH_NUCLEAR_FISSION', 'TECH_NUCLEAR_FUSION', 'none');
...
UPDATE Technologies SET GridX=2, Era='ERA_ANCIENT' WHERE Type IN ('TECH_SAILING', 'TECH_CALENDAR', 'TECH_WRITING', 'TECH_TRAPPING', 'TECH_THE_WHEEL', 'TECH_TRAINING', 'TECH_BRONZE_WORKING', 'TECH_MASONRY', 'none');
