...
INSERT INTO Leader_Flavors(FlavorType, LeaderType, Flavor) SELECT 'FLAVOR_MELEE', Type, 4 FROM Leaders WHERE Type = 'LEADER_ASKIA';
INSERT INTO Leader_Flavors(FlavorType, LeaderType, Flavor) SELECT 'FLAVOR_MELEE', Type, 4 FROM Leaders WHERE Type = 'LEADER_ATTILA';
INSERT INTO Leader_Flavors(FlavorType, LeaderType, Flavor) SELECT 'FLAVOR_MELEE', Type, 4 FROM Leaders WHERE Type = 'LEADER_AUGUSTUS';
INSERT INTO Leader_Flavors(FlavorType, LeaderType, Flavor) SELECT 'FLAVOR_MELEE', Type, 4 FROM Leaders WHERE Type = 'LEADER_GENGHIS_KHAN';
INSERT INTO Leader_Flavors(FlavorType, LeaderType, Flavor) SELECT 'FLAVOR_MELEE', Type, 4 FROM Leaders WHERE Type = 'LEADER_HARALD';
INSERT INTO Leader_Flavors(FlavorType, LeaderType, Flavor) SELECT 'FLAVOR_MELEE', Type, 4 FROM Leaders WHERE Type = 'LEADER_ISABELLA';
INSERT INTO Leader_Flavors(FlavorType, LeaderType, Flavor) SELECT 'FLAVOR_MELEE', Type, 4 FROM Leaders WHERE Type = 'LEADER_NAPOLEON';
INSERT INTO Leader_Flavors(FlavorType, LeaderType, Flavor) SELECT 'FLAVOR_MELEE', Type, 4 FROM Leaders WHERE Type = 'LEADER_ODA_NOBUNAGA';
INSERT INTO Leader_Flavors(FlavorType, LeaderType, Flavor) SELECT 'FLAVOR_MELEE', Type, 4 FROM Leaders WHERE Type = 'LEADER_THEODORA';
INSERT INTO Leader_Flavors(FlavorType, LeaderType, Flavor) SELECT 'FLAVOR_MELEE', Type, 4 FROM Leaders WHERE Type = 'LEADER_ALEXANDER';
INSERT INTO Leader_Flavors(FlavorType, LeaderType, Flavor) SELECT 'FLAVOR_MELEE', Type, 4 FROM Leaders WHERE Type = 'LEADER_BISMARCK';
INSERT INTO Leader_Flavors(FlavorType, LeaderType, Flavor) SELECT 'FLAVOR_MELEE', Type, 4 FROM Leaders WHERE Type = 'LEADER_CATHERINE';
INSERT INTO Leader_Flavors(FlavorType, LeaderType, Flavor) SELECT 'FLAVOR_MELEE', Type, 4 FROM Leaders WHERE Type = 'LEADER_ELIZABETH';
INSERT INTO Leader_Flavors(FlavorType, LeaderType, Flavor) SELECT 'FLAVOR_MELEE', Type, 4 FROM Leaders WHERE Type = 'LEADER_GUSTAVUS_ADOLPHUS';
INSERT INTO Leader_Flavors(FlavorType, LeaderType, Flavor) SELECT 'FLAVOR_MELEE', Type, 4 FROM Leaders WHERE Type = 'LEADER_HIAWATHA';
INSERT INTO Leader_Flavors(FlavorType, LeaderType, Flavor) SELECT 'FLAVOR_MELEE', Type, 4 FROM Leaders WHERE Type = 'LEADER_MONTEZUMA';
INSERT INTO Leader_Flavors(FlavorType, LeaderType, Flavor) SELECT 'FLAVOR_MELEE', Type, 4 FROM Leaders WHERE Type = 'LEADER_WU_ZETIAN';
INSERT INTO Leader_Flavors(FlavorType, LeaderType, Flavor) SELECT 'FLAVOR_MELEE', Type, 2 FROM Leaders WHERE Type = 'LEADER_GANDHI';
INSERT INTO Leader_Flavors(FlavorType, LeaderType, Flavor) SELECT 'FLAVOR_MELEE', Type, 2 FROM Leaders WHERE Type = 'LEADER_SELASSIE';
INSERT INTO Leader_Flavors(FlavorType, LeaderType, Flavor) SELECT 'FLAVOR_MELEE', Type, 2 FROM Leaders WHERE Type = 'LEADER_KAMEHAMEHA';
INSERT INTO Leader_Flavors(FlavorType, LeaderType, Flavor) SELECT 'FLAVOR_MELEE', Type, 2 FROM Leaders WHERE Type = 'LEADER_MARIA';
INSERT INTO Leader_Flavors(FlavorType, LeaderType, Flavor) SELECT 'FLAVOR_MELEE', Type, 2 FROM Leaders WHERE Type = 'LEADER_PACHACUTI';
INSERT INTO Leader_Flavors(FlavorType, LeaderType, Flavor) SELECT 'FLAVOR_MELEE', Type, 2 FROM Leaders WHERE Type = 'LEADER_RAMESSES';
INSERT INTO Leader_Flavors(FlavorType, LeaderType, Flavor) SELECT 'FLAVOR_MELEE', Type, 2 FROM Leaders WHERE Type = 'LEADER_RAMKHAMHAENG';
INSERT INTO Leader_Flavors(FlavorType, LeaderType, Flavor) SELECT 'FLAVOR_MELEE', Type, 2 FROM Leaders WHERE Type = 'LEADER_SEJONG';
INSERT INTO Leader_Flavors(FlavorType, LeaderType, Flavor) SELECT 'FLAVOR_MELEE', Type, 2 FROM Leaders WHERE Type = 'LEADER_BOUDICCA';
INSERT INTO Leader_Flavors(FlavorType, LeaderType, Flavor) SELECT 'FLAVOR_MELEE', Type, 2 FROM Leaders WHERE Type = 'LEADER_DARIUS';
INSERT INTO Leader_Flavors(FlavorType, LeaderType, Flavor) SELECT 'FLAVOR_MELEE', Type, 2 FROM Leaders WHERE Type = 'LEADER_DIDO';
INSERT INTO Leader_Flavors(FlavorType, LeaderType, Flavor) SELECT 'FLAVOR_MELEE', Type, 2 FROM Leaders WHERE Type = 'LEADER_HARUN_AL_RASHID';
INSERT INTO Leader_Flavors(FlavorType, LeaderType, Flavor) SELECT 'FLAVOR_MELEE', Type, 2 FROM Leaders WHERE Type = 'LEADER_NEBUCHADNEZZAR';
INSERT INTO Leader_Flavors(FlavorType, LeaderType, Flavor) SELECT 'FLAVOR_MELEE', Type, 2 FROM Leaders WHERE Type = 'LEADER_PACAL';
INSERT INTO Leader_Flavors(FlavorType, LeaderType, Flavor) SELECT 'FLAVOR_MELEE', Type, 2 FROM Leaders WHERE Type = 'LEADER_SULEIMAN';
INSERT INTO Leader_Flavors(FlavorType, LeaderType, Flavor) SELECT 'FLAVOR_MELEE', Type, 2 FROM Leaders WHERE Type = 'LEADER_WASHINGTON';
INSERT INTO Leader_Flavors(FlavorType, LeaderType, Flavor) SELECT 'FLAVOR_MELEE', Type, 2 FROM Leaders WHERE Type = 'LEADER_WILLIAM';
